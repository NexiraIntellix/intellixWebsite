    ...
    <div style={{ width, height, transform: "scale(" + scale + ")", transformOrigin: "top left" }}>
      <style>{`
        ...
        @media (max-width: 640px) {
          .nx-screen-cta { margin-top: 18px; gap: 8px; }
          .nx-screen-btn {
            padding: 10px 14px;
            font-size: 13px;
            border-radius: 10px;
          }
          /* The copy sits over the globe on a phone, so it is set small enough
             to leave the sphere readable around it rather than covering it. */
          .nx-screen-copy h1 { font-size: 25px !important; }
          .nx-screen-copy p { margin-top: 12px !important; font-size: 13.5px !important; line-height: 1.5 !important; }
        }
